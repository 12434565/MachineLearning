...
class MultipleInsOuts(L.LightningModule):
    def __init__(self):
        ...
        self.input_to_hidden1 = nn.Linear(in_features=6, out_features=2, bias=True)
        self.hidden1_to_hidden2 = nn.Linear(in_features=2, out_features=2, bias=True)
        self.hidden2_to_output = nn.Linear(in_features=2, out_features=2, bias=True)
